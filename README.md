...
### Преимущества:
* Код стал короче и более читаемым. Всего 1 строка вместо 15 в первом случае, и вместо 11 во втором.
* Инкапсулирована логика - теперь JOIN скрыты
* Теперь для изменения основной логики достаточно поменять только представление, что гораздо удобнее
## Оптимизированный запрос 1:
![Оптимизация 1](https://github.com/user-attachments/assets/24063406-a0d5-46f2-91bf-fce54d36dc82)
## Оптимизированный запрос 2:
![Оптимизация 2](https://github.com/user-attachments/assets/a438a348-45a8-4a71-9c7f-2c5192bc2dc2)
